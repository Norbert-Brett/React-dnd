...
function App() {
  ...
  const draggableMarkup = (id: string) => (
    <Draggable id={id}>
      <img
        className="mx-auto h-[50px] object-contain cursor-grabbing transition ease-in duration-100 hover:scale-110"
        src={skillMap[id].image}
        alt=""
      />
      <p className="text-center p-2 font-medium text-sm">{skillMap[id].name}</p>
    </Draggable>
  )

  return (
    <>
      <nav className="px-12 flex items-center justify-between flex-wrap bg-sky-500 text-white shadow-2xl p-6">
        <h1 className="font-semibold text-2xl tracking-tight mt-2">
          Norbert Brett
        </h1>
        <div>
          <a
      ...
      <div className="m-auto px-6 md:px-12 bg-sky-100">
        <DndContext onDragEnd={handleDragEnd}>
          <div className="py-16">
            <div className="container m-auto space-y-8 px-6 md:px-12 lg:px-20">
              <div>
                <h1 className="mt-4 text-center text-3xl font-bold text-gray-800  md:text-5xl">
                  Mini Tech Wicky
                </h1>
              </div>
              <div className="mt-16 ">
                {parent ? (
                  <p className="text-base p-3 text-center text-orange-500">
                ...
                {parent === null ? (
                  ...
                  <div className="app__infoBox">
                    <img
                      ...
                      alt=""
                    />
                    <h2 className="text-2xl text-sky-600 font-bold p-2">
                      {skillMap[parent!].name}
                    </h2>
